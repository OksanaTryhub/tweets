...
const Tweets = () => {
  ...
  return (
    <div ref={userListRef} className={styles.container}>
      <div className={styles.buttonWrapper}>
        <button className={styles.backBtn} onClick={homeRedirect}>
          ← Back
        </button>
      ...
      />
      {showLoadMore && (
        <button onClick={loadMoreUsers} className={styles.loadMoreBtn}>
          Load more
        </button>
      )}
    </div>
